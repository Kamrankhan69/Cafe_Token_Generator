	...
	private synchronized void initialize() {
		...
		btnNewButton_1.addActionListener(e -> {
			...
			try {
				...
				for(int i = 0; i < table.getRowCount(); i++) {
					...
					if(Integer.parseInt(table.getModel().getValueAt(i, 1).toString()) != 0) {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				table.setValueAt(Objects.requireNonNullElse(quantity, 1), i, 1);
					
				if(Integer.parseInt(table.getValueAt(i,1).toString()) == 0) {
					int c = 100;
					table.setValueAt(c, i, 0);
					Double a = Double.parseDouble(lblNewLabel_3.getText())-Double.parseDouble(table.getValueAt(i, 4).toString());
					lblNewLabel_3.setText(Double.toString(a));
					
				}
				int a = Short.parseShort(table.getValueAt(i, 0).toString()) - Short.parseShort(table.getValueAt(i, 1).toString());
				
				table.setValueAt(a, i, 0);
				
				double sum = Short.parseShort(table.getValueAt(i, 1).toString()) * Double.parseDouble(table.getValueAt(i, 3).toString());
				table.setValueAt(sum, i, 4);
				
				for(int r = 0; r < table.getRowCount(); r++) {
					total += Double.parseDouble(table.getValueAt(r, 4).toString());
				}
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{(short) 100,(short) 0, "Chicken Biryani", 120, 0.0},
				{(short) 100,(short) 0, "Vegetable Biryani", 80, 0.0},
				{(short) 100,(short) 0, "Chicken Petes", 60, 0.0},
				{(short) 100,(short) 0, "Vegetable Petes", 40, 0.0},
				{(short) 100,(short) 0, "Chicken Roll", 50, 0.0},
				{(short) 100,(short) 0, "Vegetable Roll", 30, 0.0},
				{(short) 100,(short) 0, "Burger", 60, 0.0},
				{(short) 100,(short) 0, "Samosa", 12, 0.0},
				{(short) 100,(short) 0, "Pakorey", 20, 0.0},
				{(short) 100,(short) 0, "Banana Shake", 160, 0.0},
				{(short) 100,(short) 0, "Lemande", 120, 0.0},
				{(short) 100,(short) 0, "Fries", 40, 0.0},
			},
			new String[] {
				"Available Quanity","Quantity", "Available Items", "Rate", "Price"
			}
		) {
			final Class[] columnTypes = new Class[] {
				Short.class,Short.class, String.class, Integer.class, Double.class
			};
